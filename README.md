...
dependencies {
    ...
    testImplementation("com.github.benckx.elephantchess:xiangqi-core-test-utils:2.1.0")
    testImplementation("com.github.benckx.elephantchess:seven-kingdoms-core-test-utils:2.1.0")
}
```
