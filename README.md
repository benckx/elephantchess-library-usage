...
You can either use a released tag (e.g. `2.0.3`) or build the latest commit of a branch with the
...
dependencies {
    implementation("com.github.benckx.elephantchess:xiangqi-core:2.0.3")
    implementation("com.github.benckx.elephantchess:engine-api:2.0.3")
    implementation("com.github.benckx.elephantchess:seven-kingdoms-core:2.0.3")

    testImplementation("com.github.benckx.elephantchess:xiangqi-core-test-utils:2.0.3")
    testImplementation("com.github.benckx.elephantchess:seven-kingdoms-core-test-utils:2.0.3")
}
```
